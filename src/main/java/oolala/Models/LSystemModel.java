 ...
 * A model class to hold information about the commands running of the LSystem app. TurtleView instances are created in this class when a command is run.
 *
 * @author
 */

public class LSystemModel extends AppModel {
    public LSystemModel(CanvasScreen canvas, ResourceBundle myResources, String stampPath, SequentialTransition animation) {
        super(canvas, myResources, animation);
        turtleIcon = myResources.getString("CursorIcon");
        turtleStamp = myResources.getString(stampPath);
