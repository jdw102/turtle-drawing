...
public class ChoiceTest extends Application {
    ...
    public void start(Stage stage) {
        ...
        Button maybeButton = new Button();
        yesButton.setText("Yes");
        noButton.setText("No");
        maybeButton.setText("Maybe");
        HBox buttonsHBox = new HBox(yesButton, noButton, maybeButton);
        buttonsHBox.setSpacing(300);
        //pane.setBottom(buttonsHBox);+-
        Text question = new Text("Who are you?");
        VBox layoutVBox = new VBox(10, question, buttonsHBox);
        pane.setCenter(layoutVBox);
...
//            Font font = Font.font(families.getValue(), bold.isSelected() ? FontWeight.BOLD : FontWeight.NORMAL, italic.isSelected() ? FontPosture.ITALIC : FontPosture.REGULAR, size);
...
//
//        VBox root = new VBox(0.8 * rem, hbox(sampleText), hbox(bold, italic), hbox(small, medium, large, extraLarge), hbox(families));
//
